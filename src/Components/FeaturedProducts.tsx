    ...
    <section id="discount" className="text-white  min-height-200 w-full bg-black flex md:!pl-20 md:!py-25 !mt-6 flex-col  md:items-start md:justify-start items-center justify-center">
     <div className='!mb-10 flex flex-col align-center md:items-start justify-center  items-center '>
      ...
      <div className='flex flex-wrap   gap-12 xl:gap-5 md:!pr-15 items-center justify-center md:items-start md:justify-start lg:gap-5'>
          ...
          <Link to='/products/3'>
            <img width={500} height={500} src="/images/Seiko-Prospex-Arnie-2_fde1398b-1529-4b20-aa1d-2852c5e7d164.webp" alt="Watch" className='w-screen md:w-90 md:h-50 h-60 object-cover rounded-2xl i1'/>
          ...
          <div className=' p-4 rounded-2xl shadow-lg overflow-hidden hover:scale-105 hover:-translate-y-2 transition-all duration-500'>
          <Link to='/products/22'>
            <img width={500} height={500} src="/images/Zenith-Defy-Extreme-2_c824b1a4-97e2-4e36-ac94-d3f4db2be0a2.webp" alt="Watch" className='w-screen md:w-90 md:h-50 h-60 object-cover rounded-2xl i1'/>
          ...
          <div className=' p-4 rounded-2xl shadow-lg overflow-hidden hover:scale-105 hover:-translate-y-2 transition-all duration-500'>
          <Link to='/products/4'>
            <img width={500} height={500} src="/images/thumbnail-1-0.webp" alt="Watch" className='w-screen md:w-90 md:h-50 h-60 object-cover rounded-2xl i1'/>
