...
const Filters = ({ onApplyFilters, onClose, currentFilters }: any) => {
  ...
  const handleApplyFilters = () => {
    ...
    const filters = { minPrice, maxPrice, strapMaterial, strapColor, type };
  ...
  return (
    <div
      className="w-screen h-screen fixed z-150 bg-[rgba(0,0,0,0.5)] backdrop-blur-sm flex justify-center items-center"
      data-aos="fade-in"
    >
      <div
        className="bg-black rounded-2xl md:w-[60%] w-full z-60 max-h-[90vh] overflow-y-auto flex flex-col gap-6 p-8 text-white transform transition-all duration-300"
        data-aos="fade-up"
      >
        {/* Header */}
        <div className="flex justify-between items-center" data-aos="fade-up" data-aos-delay="100">
          ...
          <button onClick={onClose} className="text-2xl hover:text-gray-300 transition-colors">
            <IoClose />
          </button>
        </div>
        ...
        {error && (
          <div
            className="bg-red-900 border border-red-500 text-red-100 px-4 py-2 rounded-lg"
            data-aos="fade-up"
            data-aos-delay="150"
          >
            {error}
        ...
        {/* Min Price */}
        <label className="flex flex-col gap-3" data-aos="fade-up" data-aos-delay="200">
          <div className="flex items-center gap-2">
            <span className="flex flex-row w-28 items-center gap-3">
              Min Price <BsArrowRightShort />
            </span>
          ...
          <div className="flex items-center gap-3">
            <input
              type="range"
              className="flex-1 h-9 rounded-lg appearance-none cursor-pointer range range-neutral border border-white"
              max={50000000}
              min={0}
              step={1000}
              value={minPrice}
        ...
        {/* Max Price */}
        <label className="flex flex-col gap-3" data-aos="fade-up" data-aos-delay="250">
          <div className="flex items-center gap-2 flex-row">
            <span className="flex flex-row w-28 items-center gap-3">
              Max Price <BsArrowRightShort />
            </span>
          ...
          <div className="flex items-center gap-3">
            <input
              type="range"
              className="flex-1 h-9 rounded-lg appearance-none cursor-pointer slider range range-neutral border border-white"
              max={100000000}
              min={1000}
              step={1000}
              value={maxPrice}
        ...
        {/* Strap Material */}
        <label className="flex gap-3" data-aos="fade-up" data-aos-delay="300">
          <div className="flex items-center gap-2">
        ...
        {/* Strap Color */}
        <label className="flex gap-3" data-aos="fade-up" data-aos-delay="350">
          <div className="flex items-center gap-2">
        ...
        {/* Watch Type */}
        <label className="flex gap-3" data-aos="fade-up" data-aos-delay="400">
          <div className="flex items-center gap-2">
        ...
        {/* Action Buttons */}
        <div className="flex gap-4 mt-4 items-center justify-center" data-aos="fade-up" data-aos-delay="450">
          <button
            onClick={handleApplyFilters}
            disabled={!!error}
            className={`flex-1 text-white rounded-xl border border-white py-3 transition-all duration-300 ${
              error
