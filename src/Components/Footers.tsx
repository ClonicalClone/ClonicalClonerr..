...
const Footers = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">By
      ...
      <p className="mt-2 text-sm text-gray-200">Aesthetic E-Commerce Watch Brand</p>
    </div>
    <div className="grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
      <div className="lg:w-1/4  w-full px-4">
        ...
        <ul className="list-none mb-10 flex gap-4 w-full items-center justify-center md:justify-start">
          ...
          <li>
                  <Link className=" hover:text-gray-400" to='/product'>Products</Link>
          </li>
          <li>
                  <Link className=" hover:text-gray-400" to='/About'>About</Link>
          </li>
          <li>
                  <Link className=" hover:text-gray-400" to='/Contact'>Contacts</Link>
          </li>
        </ul>
