  ...
  return (
    <>
      ...
      <header className=" sticky top-0 z-50 w-full ">
        <nav className="w-full h-26 flex items-center backdrop-blur-[10px] justify-around shadow-[0px_0px_173px_-27px_rgba(231,231,231,0.689)]  animate-[shadower_4s_infinite] bg-[rgb(0,0,0,0.7)]">
          <a href="#" className="text-[25px]">ClonicalClone</a>
          <div className={`md:flex  text-lg items-center gap-13 hidden`}>
              <Link to="/" className="hover:text-gray-400 transition">Home</Link>
              <Link to="/Product" className="hover:text-gray-400 transition">Shop</Link>
