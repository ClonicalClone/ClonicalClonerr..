        ...
        <section className="bg-black text-white body-font">
          <div className="container px-5! mx-auto">
            <div className="sm:text-3xl text-2xl font-medium title-font text-center text-white pt-12! pb-21! flex justify-center items-center gap-20">
              ...
              <div className="flex flex-row text-xl justify-center items-center gap-2 cursor-pointer border! border-white! p-2! rounded-full px-4! hover:scale-105 transition-all duration-200" onClick={() => { setShowOffers(!showOffers) }}>
                Filter <MdFilterList />
              </div>
            </div>
